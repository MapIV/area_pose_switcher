...
public:
  ...
  : Node("point_cloud_relay")
  {
    ...
    localization_subscription_ = this->create_subscription<tier4_localization_msgs::msg::LocalizationTypeStamped>("/area_localization_type", 1, std::bind(&PointCloudRelay::localization_callback, this, std::placeholders::_1));
  }

private:
  void pointcloud_callback(const sensor_msgs::msg::PointCloud2::SharedPtr msg)
  {
    if (area_localization_type_ != tier4_localization_msgs::msg::LocalizationTypeStamped::GNSS) {
      pointcloud_publisher_->publish(*msg);
    }
  }

  void localization_callback(const tier4_localization_msgs::msg::LocalizationTypeStamped::SharedPtr msg)
  {
  ...
  rclcpp::Subscription<tier4_localization_msgs::msg::LocalizationTypeStamped>::SharedPtr localization_subscription_;

  int area_localization_type_ = tier4_localization_msgs::msg::LocalizationTypeStamped::NDT;
};
